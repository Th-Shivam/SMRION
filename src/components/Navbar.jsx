    ...
    <nav className="fixed top-0 w-full z-50 bg-surface-container-lowest/80 backdrop-blur-3xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] border-b border-outline-variant/30">
      <div className="flex justify-between items-center px-8 py-5 max-w-screen-2xl mx-auto">
        ...
        <div className="hidden md:flex gap-10 items-center">
          <Link to="/" className="font-label tracking-[0.2em] text-[10px] uppercase font-bold text-on-surface-variant hover:text-primary transition-all duration-300">Product</Link>
          <Link to="/architecture" className="font-label tracking-[0.2em] text-[10px] uppercase font-bold text-primary border-b border-primary/50 pb-1 hover:text-primary transition-all duration-300">Architecture</Link>
